...
**[⬇ Tải VsisProxy-Setup-1.0.2.exe](https://github.com/vsisnet/vsisproxy-emulator-releases/releases/latest/download/VsisProxy-Setup-1.0.2.exe)**

1. Tải file `VsisProxy-Setup-1.0.2.exe` từ link trên
...
**[⬇ Tải VsisProxy-1.0.2.zip](https://github.com/vsisnet/vsisproxy-emulator-releases/releases/latest/download/VsisProxy-1.0.2.zip)**

1. Tải file `VsisProxy-1.0.2.zip`
